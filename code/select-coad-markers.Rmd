...
hypometh_down_b <- s5 %>% filter(Compartment=="B") %>% pull(`Gene symbol`)
write_tsv(data.frame(symbol=hypometh_down_b), file="../coad_hypometh_down_b_genes.txt", col_names=FALSE)
